...
#
# However, when we do this, we also import `absa_uploader/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'absa_uploader_cli = absa_uploader.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'absa_uploader_gui = absa_uploader.gui:entry_point'
        # ]
    }
)
